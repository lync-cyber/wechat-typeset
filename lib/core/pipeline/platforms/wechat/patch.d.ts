/**
 * applyWxPatches：微信公众号 patch 链主入口。
 *
 * 由 platforms/wechat/index.ts 包装为 PlatformAdapter，供 pipeline 通过 registry 调用。
 * 公开 export（applyWxPatches / inspectPatchTargets / PatchLog / 8 个具名 patch）
 * 集中在 platforms/wechat/index.ts。
 *
...
export declare function applyWxPatches(html: string, opts?: WxPatchOptions): string;
export { patchListWrap, stripForbiddenAttrs, stripForbiddenTags, stripFontFamily, patchSvgUrlQuotes, patchSvgIds, patchFlexToFallback, patchSvgWhiteBg, };
