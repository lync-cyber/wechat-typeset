...
// App 组合根：仅承载"模板里直接用"的 ref/computed/handler；其余拆到邻居 src/app/*.ts。
...
import { md, baseThemeId, hoverThemeId, customTheme, mobileTab, activeTheme, editorWidth } from '../ui/state/store'
import { uiThemeMode } from '../ui/state/uiTheme'
