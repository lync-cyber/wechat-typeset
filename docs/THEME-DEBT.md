...
11 个 variant 当前无主题以默认骨架使用、无 `designedFor` 推荐，仍保留在
...
admonition/top-bottom-rule designedFor 冲突修复（前称 signatureOf）；4 个 variant 错误的 experimental
